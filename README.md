...
1 单机系统主页 https://secret-crag-96471.herokuapp.com/ 课访问至房源及其周围地理信息实体展示页面，单机右上方功能栏第一个按钮课显示当前地图内容图例。

2 单机功能栏第二个按钮，可选择显示当前地图页面所要呈现的内容。

3 单机功能栏第三个按钮为切换地图底图。

4 功能栏第四个按钮可自定义房源属性查询。

5 功能栏第五个按钮为周边空间查询，先在功能框中点击选择地点按钮，然后再在地图上任意点击选择地点，系统即可返回该点出周边空间地理实体信息。
